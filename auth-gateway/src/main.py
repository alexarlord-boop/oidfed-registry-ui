"""
OIDFED Auth Gateway - Main Application
...
app = FastAPI(
    ...
    description="Authentication gateway for OIDFED Registry with OIDC support",
...
async def startup():
    ...
    print(f"📝 Documentation: http://localhost:9000/docs")
